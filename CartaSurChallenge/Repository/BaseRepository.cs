...
namespace CartaSurChallenge.Repository
{
    ...
    {
        protected readonly CartaSurChallengeDbContext _dbContext;

        public EfRepository(CartaSurChallengeDbContext dbContext)
        {
